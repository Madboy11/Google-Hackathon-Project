...
} from "./chunk-7FZLAOPM.js";
import {
  luma
} from "./chunk-MMGIH7NV.js";
import {
  require_react
...
var ZoomWidget = class extends Widget {
  ...
  handleZoomIn() {
    var _a;
    const viewIds = this.viewId ? [this.viewId] : ((_a = this.deck) == null ? void 0 : _a.getViews().map((v3) => v3.id)) ?? [];
...
var ResetViewWidget = class extends Widget {
  ...
  resetViewState(viewState) {
    ...
    for (const viewId of viewIds) {
      ...
      (_c = (_b = this.props).onReset) == null ? void 0 : _c.call(_b, { viewId, viewState: nextViewState });
      this.setViewState(viewId, nextViewState);
    }
  }
};
  ...
  flyTo(viewState) {
    ...
    for (const viewId of viewIds) {
      if ("longitude" in viewState && "latitude" in viewState) {
        (_c = (_b = this.props).onGeocode) == null ? void 0 : _c.call(_b, {
          viewId,
          coordinates: {
